export class InternationalizationManager {
    constructor(config) {
        ...
        Object.defineProperty(this, "fallbackLocale", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "loadedLocales", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Set()
        ...
        if (!InternationalizationManager.instance) {
            const defaultConfig = {
                ...
                loadLocaleData: async (locale) => {
                    ...
                    return (InternationalizationManager.DEFAULT_TRANSLATIONS[fullLocale] ||
                        InternationalizationManager.DEFAULT_TRANSLATIONS["en-US"]);
                },
            };
            InternationalizationManager.instance = new InternationalizationManager(config || defaultConfig);
        }
...
Object.defineProperty(InternationalizationManager, "DEFAULT_TRANSLATIONS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
        "en-US": {
            ...
            accessibility: {
                ...
                dropzoneDescription: "Drag and drop files here or click to browse. Supported formats: images, PDFs, and text files.",
